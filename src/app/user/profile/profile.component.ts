...
export class ProfileComponent implements OnInit{
  ...
  createProfileForm() {
    this.profileForm = new FormGroup({
      ...
      firstName: new FormControl('',[Validators.required,Validators.pattern(this.regExAllowStringAndSpace)]),
      lastName: new FormControl('',[Validators.required,Validators.pattern(this.regExAllowStringAndSpace)]),
      address1: new FormControl('',[Validators.required]),
      city: new FormControl('',[Validators.required,Validators.pattern(this.regExAllowStringAndSpace)]),
      ...
      email: new FormControl('',[Validators.required,Validators.email,Validators.pattern(this.regExAllowEmail)]),
    });
  }
  createCardForm() {
  ...
  getProfileData() {
    this.apiService.getProfile(environment.fakeLoginEmail).subscribe(
      (res:any) => {
